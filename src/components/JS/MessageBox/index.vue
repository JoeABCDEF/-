...
.messageBox > div{display: flex;position: absolute; bottom: 0; width: 100%; border-top:  1px solid gray;}
.messageBox > div div{flex: 1; text-align: center; line-height: 30px; border-right: 1px solid gray;}
